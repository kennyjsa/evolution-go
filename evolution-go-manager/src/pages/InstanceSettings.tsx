...
import { ArrowLeft, Save, Trash2, Power, Eye, EyeOff, MessagesSquare } from "lucide-react";
    ...
    <div className="h-full flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto p-6">
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          {/* Chatwoot Card — a configuração do conector vive em página própria
              porque tem credencial e webhook, mas o caminho até ela é aqui. */}
          <div className="rounded-lg border border-sidebar-border bg-card p-6">
            <div className="flex items-center justify-between">
              <div>
